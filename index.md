...
In my spare time ~~I'm also~~ *I was* the co-founder of the ~~social~~ *failed* startup [Weave](http://www.weave.ws). We tried to develop something that allows the user to unexpectedly find and deeply connect with content that has a purpose; our ultimate goal is to help users explore and share meaningful moments through their social network.
